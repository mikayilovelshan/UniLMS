        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cafedras_Faculties_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CafedraId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Cafedras_CafedraId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CafedraId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specialities_Cafedras_CafedraId",
                        column: x => x.CafedraId,
                        principalTable: "Cafedras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScientificDegree = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseSpeciality", x => new { x.CourseId, x.SpecialityId });
                    table.ForeignKey(
                        name: "FK_CourseSpeciality_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseSpeciality_Specialities_SpecialityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseOfferings_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResults_CourseOfferings_CourseOfferingId",
                        column: x => x.CourseOfferingId,
                        principalTable: "CourseOfferings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_CourseSchedules_CourseScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_CourseScheduleId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cafedras_Code",
                table: "Cafedras",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cafedras_FacultyId",
                table: "Cafedras",
                column: "FacultyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseOfferings_GroupId_CourseId_SemesterId",
                table: "CourseOfferings",
                columns: new[] { "GroupId", "CourseId", "SemesterId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseSchedules_CourseOfferingId_DayOfWeek_StartTime",
                table: "CourseSchedules",
                columns: new[] { "CourseOfferingId", "DayOfWeek", "StartTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseSpeciality_SpecialityId",
                table: "CourseSpeciality",
                column: "SpecialityId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_CourseOfferingId",
                table: "ExamResults",
                column: "CourseOfferingId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_StudentId_CourseOfferingId_ExamType",
                table: "ExamResults",
                columns: new[] { "StudentId", "CourseOfferingId", "ExamType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specialities_CafedraId",
                table: "Specialities",
                column: "CafedraId");
